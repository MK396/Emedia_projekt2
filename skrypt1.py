...
def main():
    klucz_publiczny, klucz_prywatny, iloczyn_p_q, phi_n, p, q = generuj_klucze(bity=12)
    ...
    if opcja == '1':
        ...
        zaszyfrowane_bajty = b''.join(long_to_bytes(c) for c in zaszyfrowane)
